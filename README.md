...
For LLaMA-2 70B and Mixtral 8x7b, the intermediate goals can be generated by NVIDIA NIM APIs. You can get a free API key from the [NVIDIA NIM](https://build.nvidia.com/meta/llama3-70b) page.

For ChatGPT-3.5 and ChatGPT-4, an OpenAI API key is required.
