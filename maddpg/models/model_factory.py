...
def get_model_fn(name, **kwargs):
    MODEL_MAP = {
        ...
        'gcn_mean': functools.partial(graph_net.GraphNet, pool_type='avg', **kwargs),
        'gcn_max': functools.partial(graph_net.GraphNet, pool_type='max', **kwargs),
        'gat_mean': functools.partial(graph_net.GraphAttnNet, pool_type='avg', **kwargs),
        'gat_max': functools.partial(graph_net.GraphAttnNet, pool_type='max', **kwargs),
